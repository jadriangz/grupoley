...
# -----------------------------------------------------------------------------------------------------------------------
    ...
    def _get_achived_task_in_time(self):
        for task in self:
            task.ensure_one()
            if task.task_id.difference >= 0 and task.task_id.x_in_validation == True:
                task.x_achived_task_in_time = True
            elif task.task_id.difference >= 0 and task.task_id.is_closed == True:
                task.x_achived_task_in_time = True
            else:
    ...
    def _get_achived_task_with_overtime(self):
        for task in self:
            task.ensure_one()
            if (task.difference < 0 and task.task_id.x_in_validation == True):
                task.x_achived_task_with_overtime = True
            elif task.difference < 0 and task.task_id.is_closed == True:
                task.x_achived_task_with_overtime = True
            else:
